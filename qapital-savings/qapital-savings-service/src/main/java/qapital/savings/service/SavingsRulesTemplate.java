...
public class SavingsRulesTemplate {
  ...
  public static List<SavingsRule> getActiveRulesForUser(Long userId) {
    List<SavingsRule> savingsRules = List.of();
  ...
  private static Optional<SavingsRule> createSavingsRule(Long id, Long userId, String placeDescription , RuleType ruleType, Double amount) {
